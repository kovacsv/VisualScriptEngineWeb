var EditorInterface = function (module)
{
	...
	this.createNodeFunc = module.cwrap ('CreateNode', null, ['number', 'number', 'number', 'number']);
...
EditorInterface.prototype.CreateNode = function (groupId, nodeId, positionX, positionY)
{
	this.createNodeFunc (groupId, nodeId, positionX, positionY);
};
